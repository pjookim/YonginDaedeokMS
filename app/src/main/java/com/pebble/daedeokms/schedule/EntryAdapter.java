...
public class EntryAdapter extends ArrayAdapter<ScheduleActivity.Item> {

    private ArrayList<ScheduleActivity.Item> mArrayList;
    private LayoutInflater mInflater;

    public EntryAdapter(Context mContext, ArrayList<ScheduleActivity.Item> mArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ScheduleActivity.Item mitem = mArrayList.get(position);
        if (mitem == null)
            return convertView;
