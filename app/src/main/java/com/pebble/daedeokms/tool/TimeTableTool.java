...
public class TimeTableTool {
    ...
    public final static String mFilePath = "/data/data/com.pebble.daedeokms/databases/";
    public final static String mGoogleSpreadSheetUrl = "https://docs.google.com/spreadsheets/d/1lrL3m0OuZj_LC-1v4QEEhwpsGkuq6pkj06AIKImb3rM/pubhtml?gid=0&single=true";
